...
def getBootstrap(N, opt = None):
    ...
    neg = {"oddIntv":[[3, 7, 2, 4, 1, 3, 2, 4, 4], [3, 7, 2, 4, 1, 3, 2, 4, 8], [1, 3, 2, 4, 3, 7, 2, 4, 8],
     [1, 3, 2, 4, 3, 7, 2, 4, 4], [-3, 5, -10, 6, -11, 5, -6, 4, 10], [-3, 5, -10, 6, -11, 5, -6, 4, -8],
     [-11, 5, -6, 4, -3, 5, -10, 6, -8], [-11, 5, -6, 4, -3, 5, -10, 6, 10]], "evenIntv":[[3, 7, 2, 4, 1, 3, 2, 4, 4], [3, 7, 2, 4, 1, 3, 2, 4, 8], [1, 3, 2, 4, 3, 7, 2, 4, 8],
     [1, 3, 2, 4, 3, 7, 2, 4, 4], [-3, 5, -10, 6, -11, 5, -6, 4, 10], [-3, 5, -10, 6, -11, 5, -6, 4, -8],
     [-11, 5, -6, 4, -3, 5, -10, 6, -8], [-11, 5, -6, 4, -3, 5, -10, 6, 10]]} # [[67, 75, 51, 61, 118, 136], [67, 75, 51, 61, 118, 137], [67, 75, 51, 61, 117, 136], [87, 93, -91, -87, -4, 6], [87, 93, -91, -87, -4, 7], [87, 93, -91, -87, -5, 6]]
    return pos, neg
